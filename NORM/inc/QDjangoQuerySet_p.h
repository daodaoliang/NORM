...
class NORMSHARED_EXPORT QDjangoModelReference
{
public:
...
class NORMSHARED_EXPORT QDjangoReverseReference
{
public:
    QString leftHandKey;
...
/** \internal
 */
class NORMSHARED_EXPORT QDjangoCompiler
{
public:
...
/** \internal
 */
class NORMSHARED_EXPORT QDjangoQuerySetPrivate
{
public:
